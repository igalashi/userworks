#ifndef E16DAQ_FILE_SINK_H_
#define E16DAQ_FILE_SINK_H_
...
private:
   ...
   std::unique_ptr<e16::FileUtil> fFile;
   e16::FileUtil::CompressFunc fCompress;
   ...
   int fInProcMQLength;
   std::unique_ptr<e16::daq::TaskProcessorMT> fWorker;
