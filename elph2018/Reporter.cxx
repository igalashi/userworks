...
uint64_t
highp::e50::
Reporter::AddInputMessageSize(uint64_t n)
{
  auto& r = Instance();
  r.fMsgIn += n;
...
uint64_t
highp::e50::
Reporter::AddInputMessageSize(const FairMQParts& parts) 
{
...
uint64_t
highp::e50::
Reporter::AddOutputMessageSize(uint64_t n)
{
  auto& r = Instance();
  r.fMsgOut += n;
...
uint64_t
highp::e50::
Reporter::AddOutputMessageSize(const FairMQParts& parts)
{
...
highp::e50::Reporter& 
highp::e50::
Reporter::Instance(FairMQProgOptions* config)
{
...
void
highp::e50::
Reporter::Set(const std::string& content)
{
  auto& r = Instance();
